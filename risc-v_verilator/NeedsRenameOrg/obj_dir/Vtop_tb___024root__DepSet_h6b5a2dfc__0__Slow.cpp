...
#endif
                VL_FATAL_MT("top_tb.sv", 3, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop_tb___024root___ctor_var_reset(Vtop_tb___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 2048; ++__Vi0) {
        vlSelf->top_tb__DOT__tb_init_imem__Vstatic__instr_hex[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 2048; ++__Vi0) {
        vlSelf->top_tb__DOT__tb_init_imem__Vstatic__pc_val[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->top_tb__DOT__T1__DOT__next_pred_pc_fetch_iss = VL_RAND_RESET_I(32);
    vlSelf->top_tb__DOT__T1__DOT__brn_pred_fetch_iss = VL_RAND_RESET_I(1);
    ...
    vlSelf->top_tb__DOT__T1__DOT__flush_ex = VL_RAND_RESET_I(1);
    ...
    vlSelf->top_tb__DOT__T1__DOT__n_ex_mem = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__T1__DOT__branch_taken_ex = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__T1__DOT__read_data_dmem_ram_mem_wb = VL_RAND_RESET_I(32);
