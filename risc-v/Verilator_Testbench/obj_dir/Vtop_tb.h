...
class Vtop_tb VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vtop_tb_adder* const __PVT__top_tb__DOT__T1__DOT__ADD1;
    Vtop_tb_adder* const __PVT__top_tb__DOT__T1__DOT__ADD2;
    Vtop_tb_adder* const __PVT__top_tb__DOT__T1__DOT__A1__DOT__A1;
