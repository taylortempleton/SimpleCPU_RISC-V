...
VL_INLINE_OPT VlCoroutine Vtop_tb___024root___eval_initial__TOP__0(Vtop_tb___024root* vlSelf) {
    ...
    // Init
    std::string top_tb__DOT__init_imem__Vstatic__instr_hex_s;
    std::string top_tb__DOT__init_imem__Vstatic__pc_values_hex_s;
    std::string __Vtask_top_tb__DOT__init_imem__0__test_name;
    ...
    if (VL_UNLIKELY((! VL_VALUEPLUSARGS_INN(64, std::string{"test=%s"}, 
        ...
        VL_WRITEF("[%0t] %%Error: top_tb.sv:135: Assertion failed in %Ntop_tb\n",
                  64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("../riscv-pipeline/testbench/top_tb.sv", 135, "");
    }
    VL_WRITEF("Name of test to be run: %@ \n\n",-1,
              &(vlSelf->top_tb__DOT__test_name));
    __Vtask_top_tb__DOT__init_imem__0__test_name = vlSelf->top_tb__DOT__test_name;
    top_tb__DOT__init_imem__Vstatic__instr_hex_s = 
        VL_CONCATN_NNN(__Vtask_top_tb__DOT__init_imem__0__test_name, 
                       std::string{".hex"});
    top_tb__DOT__init_imem__Vstatic__pc_values_hex_s 
        = VL_CONCATN_NNN(__Vtask_top_tb__DOT__init_imem__0__test_name, 
                         std::string{"_pc.hex"});
    VL_READMEM_N(true, 32, 2048, 0, VL_CVT_PACK_STR_NN(top_tb__DOT__init_imem__Vstatic__instr_hex_s)
                 ,  &(vlSelf->top_tb__DOT__init_imem__Vstatic__instr_hex)
                 , 0U, ~0ULL);
    VL_READMEM_N(true, 32, 2048, 0, VL_CVT_PACK_STR_NN(top_tb__DOT__init_imem__Vstatic__pc_values_hex_s)
